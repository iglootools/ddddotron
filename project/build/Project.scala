...
class Project(info: ProjectInfo) extends ParentProject(info) with IdeaProject  {
  ...
  object Dependencies {
    ...
    val IglootoolsCommonsVersion = "0.2"
  ...
  class Api(info: ProjectInfo) extends DefaultProject(info) with IdeaProject {
    ...
    lazy val iglootoolsCommonsScalaLang = "org.iglootools.commons" %% "iglootools-commons-scala-lang" % Dependencies.IglootoolsCommonsVersion
  ...
  class EventStore(info: ProjectInfo) extends DefaultProject(info) with IdeaProject {
    ...
    lazy val iglootoolsCommonsScalaLang = "org.iglootools.commons" %% "iglootools-commons-ext" % Dependencies.IglootoolsCommonsVersion
